package net.hamnd.testmod.entity.ai.goal;
...
public class CustomFollowOwnerGoal extends Goal {
    private final DaisyEntity tameable;
    ...
    public CustomFollowOwnerGoal(DaisyEntity tameable, double speed, float minDist, float maxDist, boolean teleportToLeaves) {
